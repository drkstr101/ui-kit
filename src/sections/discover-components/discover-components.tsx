...
import { H2, H3 } from '@waweb/uikit.elements.heading';
...
export function DiscoverComponents(props: HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      ...
      data-bit-id="watheia.waweb/sections/discover-components"
    >
      <div className={classNames(textColumn, marginCenter)}>
        ...
        >
          ...
          Bit makes sure every single component is documented, organized and
      ...
      >
        ...
        <div>
          ...
          <Paragraph>
            With Bit, you can focus on writing code and watch how every
      ...
      >
        <div>
          ...
          <Paragraph>
            ...
            hot-reloading playground lets you quickly learn how components work
            and save examples.
          </Paragraph>
        </div>
