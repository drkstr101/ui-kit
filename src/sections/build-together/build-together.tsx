...
export function BuildTogether(props: HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      ...
      data-bit-id="watheia.waweb/sections/build-together"
    >
      <div className={classNames(textColumn, marginCenter)}>
        ...
        <Paragraph size={PossibleSizes.lg} className={styles.subtitle}>
          Bit empowers teams to deliver more often and faster to production
          while making sure all applications and teams are updated in perfect
          sync and harmony.
        </Paragraph>
      </div>
      ...
      >
        ...
        <div className={styles.text}>
          ...
          <Paragraph>
            Bit's component-driven CI propogates changes to all impacted
