...
import { GithubLink } from '@waweb/uikit.marketing.community-links.github-link';
import { links } from '@waweb/uikit.content.links';
import { SlackLink } from '@waweb/uikit.marketing.community-links.slack-link';
import { H2 } from '@waweb/uikit.elements.heading';
import { TwitterLink } from '@waweb/uikit.marketing.community-links.twitter-link';
import { TwitterCard } from '@waweb/uikit.marketing.twitter-card';
...
export function CommunitySection(props: CommunitySectionProps) {
  ...
  return (
    <Grid
      ...
      data-bit-id="watheia.waweb/sections/community"
    >
      ...
      <div className={styles.tweets}>
        ...
        <TwitterCard
          ...
          textId="twitterText2"
        >
          Bit, a distributed virtual component repository for projects built in
          a modular way.
        </TwitterCard>
      </div>
    </Grid>
